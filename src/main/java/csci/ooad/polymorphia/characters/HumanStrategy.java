...
public class HumanStrategy implements Strategy {
    ...
    // Convert the string input into CommandOption enum
    public Command getCommandFromString(Character character, String choiceString) {

            CommandOption choice = CommandOption.valueOf(choiceString.toUpperCase());
            return getCommand(character, choice);
    }
